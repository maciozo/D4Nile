...
//i2c_writeReg(MPU9250_WRITE, PWR_MGMT_1, 0x00, 8);

c=0x00;
i2c_writeReg(MPU9250_WRITE, PWR_MGMT_1, &c, 8);
//regv= i2c_readReg(MPU9250_WRITE, PWR_MGMT_1, &regv, 8);
...
int16_t  whoami(void){
//i2c_readReg(MPU9250_WRITE, WHO_AM_I, value, 8);
